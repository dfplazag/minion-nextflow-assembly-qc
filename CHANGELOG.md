...
- Added the missing NanoStats helper script and contributing guide expected by the repository checks.
- Updated repository checks to preserve numbered Markdown lists and parse the Nextflow config with the correct command syntax.
